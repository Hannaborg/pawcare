...
dog3 = Dog.create!(name: "Lady", breed: "Cocker Spaniel", description: "Lady is rather demure and naive but makes a good friend to those who know her and is very faithful to her family. She is not completely helpless it is shown that she can be brave and protective. She was not afraid of the rat and would chase it away from her home and she took on the responsibility to protect Jim Jr.", address: "Rua Sesamo Farmaceurica, Lisbon, Portugal", user_id: user1.id)
